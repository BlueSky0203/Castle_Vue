<template>
  <transition name="fade">
    <div
      v-if="visible"
      :class="['fixed top-4 left-1/2 transform -translate-x-1/2 z-50 px-6 py-4 rounded-md shadow-md flex items-center space-x-2', bgColor]"
    >
      <svg :class="['w-5 h-5', iconColor]" viewBox="0 0 24 24">
